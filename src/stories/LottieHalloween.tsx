...
const LottieHalloween: React.FC = () => {
  ...
  return (
    <div className="App">
      ...
      <Button title="toggle direction" onClick={toggleAnimationDirection} style={{ width: "12.55rem" }} />
      <Button title={`speed: ${state.playSpeed === 1 ? 2 : 1}`} onClick={setSpeed} style={{ width: "12.55rem" }} />
